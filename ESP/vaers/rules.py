...
VACCINE_MAPPING = {
    "BCG IMMUNIZATION":Vaccine.objects.get(code=str(19)),
    "CHOLERA VACCINE":Vaccine.objects.get(code=str(26)),
    "CMV IMMUNE GLOBULIN":Vaccine.objects.get(code=str(8)),
    "DT VACCINE (CHILD)":Vaccine.objects.get(code=str(28)),
    "DTAP VACCINE":Vaccine.objects.get(code=str(20)),
    "DTAP-HEP B-IPV":Vaccine.objects.get(code=str(110)),
    "DTAP-HEP B-IPV (PEDIARIX)":Vaccine.objects.get(code=str(110)),
    "DTAP-HFLU B CONJ VACCINE":Vaccine.objects.get(code=str(50)),
    "DTAP-HFLU B CONJ-IPV (PENTACEL)":Vaccine.objects.get(code=str(120)),
    "DTAP-HFLU B CONJ-IPV VACCINE":Vaccine.objects.get(code=str(120)),
    "DTAP-IPV VACCINE":Vaccine.objects.get(code=str(130)),
    "DTP VACCINE":Vaccine.objects.get(code=str(1)),
    "DTP-HFLU B CONJ VACCINE":Vaccine.objects.get(code=str(22)),
    "HEP A & B VACCINE ADULT":Vaccine.objects.get(code=str(104)),
    "HEP A IMMUNE GLOBULIN":Vaccine.objects.get(code=str(999)),
    "HEP A VACCINE":Vaccine.objects.get(code=str(999)),
    "HEP A VACCINE ADULT":Vaccine.objects.get(code=str(52)),
    "HEP A VACCINE PEDI/ADOL-2 DOSE SCHED":Vaccine.objects.get(code=str(83)),
    "HEP A VACCINE PEDI/ADOL-3 DOSE SCHED":Vaccine.objects.get(code=str(84)),
    "HEP B - HFLU B CONJ (PRP-OMP)":Vaccine.objects.get(code=str(999)),
    "HEP B IMMUNE BY SEROLOGY":Vaccine.objects.get(code=str(999)),
    "HEP B IMMUNE GLOBULIN (HBIG)":Vaccine.objects.get(code=str(30)),
    "HEP B VACCINE (11-19 YEARS)":Vaccine.objects.get(code=str(8)),
    "HEP B VACCINE (20+ YEARS)":Vaccine.objects.get(code=str(43)),
    "HEP B VACCINE (<11 YEARS)":Vaccine.objects.get(code=str(999)),
    "HEP B VACCINE (ILL PT, ANY AGE)":Vaccine.objects.get(code=str(999)),
    "HEP B VACCINE (PLASMA-DERIVED)":Vaccine.objects.get(code=str(999)),
    "HEP B VACCINE (RECOMBINANT)":Vaccine.objects.get(code=str(999)),
    "HEP B VACCINE ADOL-2 DOSE SCHED":Vaccine.objects.get(code=str(999)),
    "HFLU B (NON-CONJ)":Vaccine.objects.get(code=str(999)),
    "HFLU B (UNSPECIFIED)":Vaccine.objects.get(code=str(999)),
    "HFLU B CONJ (HBOC)":Vaccine.objects.get(code=str(47)),
    "HFLU B CONJ (PRP-D)":Vaccine.objects.get(code=str(46)),
    "HFLU B CONJ (PRP-OMP)":Vaccine.objects.get(code=str(49)),
    "HFLU B CONJ (PRP-T)":Vaccine.objects.get(code=str(48)),
    "HPV (6, 11, 16, 18) VACCINE":Vaccine.objects.get(code=str(62)),
    "HPV VACCINE(16, 18)":Vaccine.objects.get(code=str(118)),
    "HPV VACCINE(6, 11, 16, 18)":Vaccine.objects.get(code=str(62)),
    "IMMUNE GLOBULIN, IV":Vaccine.objects.get(code=str(999)),
    "IMMUNE GLOBULIN, SC":Vaccine.objects.get(code=str(999)),
    "IMMUNE SERUM GLOBULIN (ISG)":Vaccine.objects.get(code=str(999)),
    "INFLUENZA VACCINE":Vaccine.objects.get(code=str(16)),
    "JAPANESE ENCEPHALITIS VACCINE":Vaccine.objects.get(code=str(999)),
    "LYME VACCINE":Vaccine.objects.get(code=str(66)),
    "MEASLES (RUBEOLA) - MUMPS VACCINE":Vaccine.objects.get(code=str(05)),
    "MEASLES (RUBEOLA) - RUBELLA VACCINE":Vaccine.objects.get(code=str(04)),
    "MEASLES IMMUNE BY SEROLOGY":Vaccine.objects.get(code=str(999)),
    "MEASLES VACCINE (RUBEOLA)":Vaccine.objects.get(code=str(999)),
    "MENINGOC IM (MENACTRA) VACCINE":Vaccine.objects.get(code=str(108)),
    "MENINGOC SQ (MENOMUNE) VACCINE":Vaccine.objects.get(code=str(108)),
    "MENINGOCOCCAL C VACCINE (BRITISH)":Vaccine.objects.get(code=str(114)),
    "MMR VACCINE":Vaccine.objects.get(code=str(03)),
    "MMR VARICELLA VACCINE":Vaccine.objects.get(code=str(64)),
    "MMR-VARICELLA VACCINE":Vaccine.objects.get(code=str(94)),
    "MUMPS IMMUNE BY SEROLOGY":Vaccine.objects.get(code=str(999)),
    "MUMPS VACCINE":Vaccine.objects.get(code=str(999)),
    "PERTUSSIS VACCINE (MONOVALENT)":Vaccine.objects.get(code=str(11)),
    "PLAGUE VACCINE":Vaccine.objects.get(code=str(23)),
    "PNEUMOCOC/ADULT-POLYSAC":Vaccine.objects.get(code=str(999)),
    "PNEUMOCOC/PEDI-CONJUGATE":Vaccine.objects.get(code=str(999)),
    "POLIO VACCINE (INACTIVATED)":Vaccine.objects.get(code=str(10)),
    "POLIO VACCINE(ORAL,TRIVALENT)":Vaccine.objects.get(code=str(02)),
    "RABIES IMMUNE GLOBULIN (RIG)":Vaccine.objects.get(code=str(34)),
    "RABIES VACCINE":Vaccine.objects.get(code=str(999)),
    "RABIES VACCINE (HUMAN DIPLOID CELL)":Vaccine.objects.get(code=str(999)),
    "RABIES VACCINE (RHESUS DIPLOID CELL)":Vaccine.objects.get(code=str(999)),
    "RABIES VACCINE, ID":Vaccine.objects.get(code=str(40)),
    "RABIES VACCINE, IM":Vaccine.objects.get(code=str(18)),
    "RHOGAM":Vaccine.objects.get(code=str(999)),
    "ROCKY MTN SPOTTED FEVER VACCINE":Vaccine.objects.get(code=str(999)),
    "ROTAVIRUS VACCINE":Vaccine.objects.get(code=str(122)),
    "ROTAVIRUS VACCINE (ROTARIX)":Vaccine.objects.get(code=str(999)),
    "ROTAVIRUS VACCINE (ROTATEQ)":Vaccine.objects.get(code=str(999)),
    "RSV IMM GLOB (IM, SYNAGIS)":Vaccine.objects.get(code=str(71)),
    "RUBELLA IMMUNE BY SEROLOGY":Vaccine.objects.get(code=str(999)),
    "RUBELLA VACCINE":Vaccine.objects.get(code=str(999)),
    "SMALLPOX VACCINE":Vaccine.objects.get(code=str(999)),
    "TB TEST":Vaccine.objects.get(code=str(999)),
    "TD VACCINE (ADULT)":Vaccine.objects.get(code=str(999)),
    "TDAP":Vaccine.objects.get(code=str(115)),
    "TETANUS BOOSTER":Vaccine.objects.get(code=str(999)),
    "TETANUS IMMUNE GLOBULIN":Vaccine.objects.get(code=str(999)),
    "TETANUS TOXOID":Vaccine.objects.get(code=str(999)),
    "TYPHOID VACCINE (ORAL) TY21A":Vaccine.objects.get(code=str(25)),
    "TYPHOID VACCINE (PAREN,HEAT-PHENOL)":Vaccine.objects.get(code=str(53)),
    "TYPHOID VACCINE (VICPS,PAREN,CPS)":Vaccine.objects.get(code=str(101)),
    "TYPHUS VACCINE":Vaccine.objects.get(code=str(999)),
    "VACCINIA VIRUS":Vaccine.objects.get(code=str(999)),
    "VARICELLA DISEASE":Vaccine.objects.get(code=str(21)),
    "VARICELLA IMMUNE BY SEROLOGY":Vaccine.objects.get(code=str(36)),
    "VARICELLA VACCINE":Vaccine.objects.get(code=str(999)),
    "VARICELLA-ZOSTER IMMUNE GLOBULIN (VZIG)":Vaccine.objects.get(code=str(36)),
    "YELLOW FEVER VACCINE":Vaccine.objects.get(code=str(999)),
    "ZOSTER SHINGLES VACCINE":Vaccine.objects.get(code=str(121))
}
