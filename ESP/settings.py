...
if usesqlite:
    ...
    DATABASE_NAME = 'espmr'             # Or path to database file if using sqlite3.
    DATABASE_USER = 'rossSQL'             # Not used with sqlite3.
    DATABASE_PASSWORD = 'SQLross'         # Not used with sqlite3.
    DATABASE_HOST = 'godzilla'             # Set to empty string for localhost. Not used with sqlite3.
    #DATABASE_HOST = '127.0.0.1'             # Set to empty string for localhost. Not used with sqlite3.
    DATABASE_PORT = 3306             # Set to empty string for default. Not used with sqlite3.
...
ADMIN_MEDIA_PREFIX = '/ESP/demo/media/' 
