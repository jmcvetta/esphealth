...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Renaming field 'Prescription.quantity' to 'Prescription.quantity_raw'
        db.rename_column('emr_prescription', 'quantity', 'quantity_raw')
        ...
        # Deleting field 'Encounter.height'
        db.rename_column('emr_encounter', 'height', 'height_cm')

        # Deleting field 'Encounter.temperature'
        db.rename_column('emr_encounter', 'temperature', 'temperature_c')

        # Deleting field 'Encounter.weight'
        db.rename_column('emr_encounter', 'weight', 'weight_kg')

        # Adding field 'Encounter.temperature_raw'
        db.add_column('emr_encounter', 'temperature_raw', self.gf('django.db.models.fields.CharField')(max_length=64, null=True, blank=True) )

        # Adding field 'Encounter.weight_raw'
        db.add_column('emr_encounter', 'weight_raw', self.gf('django.db.models.fields.CharField')(max_length=64, null=True, blank=True) )

        # Adding field 'Encounter.height_raw'
        db.add_column('emr_encounter', 'height_raw', self.gf('django.db.models.fields.CharField')(max_length=64, null=True, blank=True) )

        # Adding field 'Encounter.bmi_raw'
        db.add_column('emr_encounter', 'bmi_raw', self.gf('django.db.models.fields.CharField')(max_length=64, null=True, blank=True) )
