...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('hef_labtestmap_excluded_positive_strings', (
        ...
        db.create_unique('hef_labtestmap_excluded_positive_strings', ['labtestmap_id', 'resultstring_id'])

        # Adding M2M table for field excluded_negative_strings on 'LabTestMap'
        db.create_table('hef_labtestmap_excluded_negative_strings', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('labtestmap', models.ForeignKey(orm['hef.labtestmap'], null=False)),
            ('resultstring', models.ForeignKey(orm['hef.resultstring'], null=False))
        ))
        ...
        db.create_unique('hef_labtestmap_excluded_indeterminate_strings', ['labtestmap_id', 'resultstring_id'])
