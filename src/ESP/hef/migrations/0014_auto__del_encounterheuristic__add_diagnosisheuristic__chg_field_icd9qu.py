...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting model 'EncounterHeuristic'
        db.delete_table('hef_encounterheuristic')

        # Adding model 'DiagnosisHeuristic'
        db.create_table('hef_diagnosisheuristic', (
        ...
        db.send_create_signal('hef', ['DiagnosisHeuristic'])

        # Changing field 'Icd9Query.heuristic'
        db.alter_column('hef_icd9query', 'heuristic_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['hef.DiagnosisHeuristic']))
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'DiagnosisHeuristic'
        db.delete_table('hef_diagnosisheuristic')

        # Changing field 'Icd9Query.heuristic'
        db.alter_column('hef_icd9query', 'heuristic_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['hef.EncounterHeuristic']))
    ...
    models = {
        ...
        'hef.diagnosisheuristic': {
            'Meta': {'ordering': "['name']", 'object_name': 'DiagnosisHeuristic'},
