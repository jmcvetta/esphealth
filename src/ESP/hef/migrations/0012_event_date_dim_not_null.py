...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Event.date_dim'
        db.alter_column('hef_event', 'date_dim_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['hef.DateDimension']))
    ...
    models = {
        ...
        'hef.event': {
            ...
            'date': ('django.db.models.fields.DateField', [], {'db_index': 'True'}),
            'date_dim': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['hef.DateDimension']"}),
