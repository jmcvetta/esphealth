...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('hef_eventrecordtag', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('event', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['hef.Event'])),
            ('content_type', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['contenttypes.ContentType'])),
            ('object_id', self.gf('django.db.models.fields.PositiveIntegerField')(db_index=True)),
        ))
        db.send_create_signal('hef', ['EventRecordTag'])

        # Adding unique constraint on 'EventRecordTag', fields ['event', 'content_type', 'object_id']
        db.create_unique('hef_eventrecordtag', ['event_id', 'content_type_id', 'object_id'])
