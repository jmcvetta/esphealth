...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('hef_event', 'provider', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['emr.Provider'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Event.provider'
        db.delete_column('hef_event', 'provider_id')
