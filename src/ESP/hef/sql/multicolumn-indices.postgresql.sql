...
--------------------------------------------------------------------------------
CREATE INDEX hef_event_event_type_date ON hef_event (event_type_id, date);
CREATE INDEX hef_event_patient_event_type_date ON hef_event (patient_id, event_type_id, date);
