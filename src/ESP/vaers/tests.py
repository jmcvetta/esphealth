...
class TestIcd9DiagnosisIdentification(unittest.TestCase):
    def testRegularCodes(self):
        ...
        self.assertEqual(diagnostics[guillian_barre_code]['category'], 'default')
...
class TestReports(unittest.TestCase):
    ...
    def testTemporalClusteringReport(self):
        ...
        reports.temporal_clustering(self.filename, start_date=NOW-ONE_WEEK)
...
#        TestReports
#        TestHL7Reporter
#        TestLxEventDetection
#        TestIcd9DiagnosisIdentification
        TestIcd9CodeMatching
        )
