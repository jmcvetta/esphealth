...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Removing unique constraint on 'EncounterHeuristic', fields ['icd9_codes', 'code_match_type']
        db.delete_unique('hef_encounterheuristic', ['icd9_codes', 'code_match_type'])

        # Adding model 'Icd9Query'
        db.create_table('hef_icd9query', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('heuristic', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['hef.EncounterHeuristic'])),
            ('icd9_exact', self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True)),
            ('icd9_starts_with', self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True)),
            ('icd9_ends_with', self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True)),
            ('icd9_contains', self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True)),
        ))
        db.send_create_signal('hef', ['Icd9Query'])

        # Adding unique constraint on 'Icd9Query', fields ['heuristic', 'icd9_exact', 'icd9_starts_with', 'icd9_ends_with', 'icd9_contains']
        db.create_unique('hef_icd9query', ['heuristic_id', 'icd9_exact', 'icd9_starts_with', 'icd9_ends_with', 'icd9_contains'])

        # Adding field 'LabResultFixedThresholdHeuristic.name'
        db.add_column('hef_labresultfixedthresholdheuristic', 'name', self.gf('django.db.models.fields.SlugField')(default=0, unique=True, max_length=50, db_index=True), keep_default=False)

        # Adding field 'PrescriptionHeuristic.name'
        db.add_column('hef_prescriptionheuristic', 'name', self.gf('django.db.models.fields.SlugField')(default=0, unique=True, max_length=50, db_index=True), keep_default=False)

        # Adding field 'PrescriptionHeuristic.notes'
        db.add_column('hef_prescriptionheuristic', 'notes', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)

        # Deleting field 'EncounterHeuristic.icd9_codes'
        db.delete_column('hef_encounterheuristic', 'icd9_codes')

        # Deleting field 'EncounterHeuristic.code_match_type'
        db.delete_column('hef_encounterheuristic', 'code_match_type')

        # Adding field 'EncounterHeuristic.name'
        db.add_column('hef_encounterheuristic', 'name', self.gf('django.db.models.fields.SlugField')(default=0, unique=True, max_length=50, db_index=True), keep_default=False)

        # Adding field 'LabResultPositiveHeuristic.name'
        db.add_column('hef_labresultpositiveheuristic', 'name', self.gf('django.db.models.fields.SlugField')(default=0, unique=True, max_length=50, db_index=True), keep_default=False)

        # Deleting field 'Heuristic.name'
        db.delete_column('hef_heuristic', 'name')

        # Adding field 'LabResultRatioHeuristic.name'
        db.add_column('hef_labresultratioheuristic', 'name', self.gf('django.db.models.fields.SlugField')(default=0, unique=True, max_length=50, db_index=True), keep_default=False)

        # Adding field 'LabResultAnyHeuristic.name'
        db.add_column('hef_labresultanyheuristic', 'name', self.gf('django.db.models.fields.SlugField')(default=0, unique=True, max_length=50, db_index=True), keep_default=False)

        # Adding field 'LabOrderHeuristic.name'
        db.add_column('hef_laborderheuristic', 'name', self.gf('django.db.models.fields.SlugField')(default=0, unique=True, max_length=50, db_index=True), keep_default=False)

        # Changing field 'LabOrderHeuristic.heuristic_ptr'
        db.alter_column('hef_laborderheuristic', 'heuristic_ptr_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['hef.Heuristic'], unique=True))


    def backwards(self, orm):
        
        # Removing unique constraint on 'Icd9Query', fields ['heuristic', 'icd9_exact', 'icd9_starts_with', 'icd9_ends_with', 'icd9_contains']
        db.delete_unique('hef_icd9query', ['heuristic_id', 'icd9_exact', 'icd9_starts_with', 'icd9_ends_with', 'icd9_contains'])
        ...
        # Deleting model 'Icd9Query'
        db.delete_table('hef_icd9query')

        # Deleting field 'LabResultFixedThresholdHeuristic.name'
        db.delete_column('hef_labresultfixedthresholdheuristic', 'name')

        # Deleting field 'PrescriptionHeuristic.name'
        db.delete_column('hef_prescriptionheuristic', 'name')

        # Deleting field 'PrescriptionHeuristic.notes'
        db.delete_column('hef_prescriptionheuristic', 'notes')

        # We cannot add back in field 'EncounterHeuristic.icd9_codes'
        raise RuntimeError(
            "Cannot reverse this migration. 'EncounterHeuristic.icd9_codes' and its values cannot be restored.")

        # Adding field 'EncounterHeuristic.code_match_type'
        db.add_column('hef_encounterheuristic', 'code_match_type', self.gf('django.db.models.fields.CharField')(default='exact', max_length=32, db_index=True), keep_default=False)

        # Deleting field 'EncounterHeuristic.name'
        db.delete_column('hef_encounterheuristic', 'name')

        # Adding unique constraint on 'EncounterHeuristic', fields ['icd9_codes', 'code_match_type']
        db.create_unique('hef_encounterheuristic', ['icd9_codes', 'code_match_type'])

        # Deleting field 'LabResultPositiveHeuristic.name'
        db.delete_column('hef_labresultpositiveheuristic', 'name')

        # We cannot add back in field 'Heuristic.name'
        raise RuntimeError(
            "Cannot reverse this migration. 'Heuristic.name' and its values cannot be restored.")

        # Deleting field 'LabResultRatioHeuristic.name'
        db.delete_column('hef_labresultratioheuristic', 'name')

        # Deleting field 'LabResultAnyHeuristic.name'
        db.delete_column('hef_labresultanyheuristic', 'name')

        # Deleting field 'LabOrderHeuristic.name'
        db.delete_column('hef_laborderheuristic', 'name')

        # Changing field 'LabOrderHeuristic.heuristic_ptr'
        db.alter_column('hef_laborderheuristic', 'heuristic_ptr_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['hef.Heuristic'], unique=True, primary_key=True))
    ...
    models = {
        ...
        'hef.encounterheuristic': {
            'Meta': {'ordering': "['name']", 'object_name': 'EncounterHeuristic'},
        ...
        'hef.icd9query': {
            ...
            'heuristic': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['hef.EncounterHeuristic']"}),
        ...
        'hef.laborderheuristic': {
            'Meta': {'object_name': 'LabOrderHeuristic'},
            'heuristic_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['hef.Heuristic']", 'unique': 'True'}),
            'name': ('django.db.models.fields.SlugField', [], {'unique': 'True', 'max_length': '50', 'db_index': 'True'}),
            'notes': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'test': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['hef.AbstractLabTest']", 'unique': 'True'})
        },
        'hef.labresultanyheuristic': {
            'Meta': {'ordering': "['test']", 'object_name': 'LabResultAnyHeuristic'},
            'heuristic_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['hef.Heuristic']", 'unique': 'True', 'primary_key': 'True'}),
            'name': ('django.db.models.fields.SlugField', [], {'unique': 'True', 'max_length': '50', 'db_index': 'True'}),
            'notes': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'test': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['hef.AbstractLabTest']", 'unique': 'True'})
        ...
        'hef.labresultpositiveheuristic': {
            'Meta': {'ordering': "['test']", 'object_name': 'LabResultPositiveHeuristic'},
            'date_field': ('django.db.models.fields.CharField', [], {'default': "'order'", 'max_length': '32'}),
            'heuristic_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['hef.Heuristic']", 'unique': 'True', 'primary_key': 'True'}),
            'name': ('django.db.models.fields.SlugField', [], {'unique': 'True', 'max_length': '50', 'db_index': 'True'}),
            'notes': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
        ...
        'hef.prescriptionheuristic': {
            'Meta': {'ordering': "['name']", 'object_name': 'PrescriptionHeuristic'},
