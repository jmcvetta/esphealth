...
def vaers_csv(no_phi):
    ...
    writer.writerow(['Case_id',
              ...
              'Lab_result_value5', 
              'Lab_count',   
              'DX_CODE_result_date1',
              'DX_CODE_result_text1',
              'DX_CODE_result_code1',
              'DX_CODE_result_date2',
              'DX_CODE_result_text2',
              'DX_CODE_result_code2',
              'DX_CODE_result_date3',
              'DX_CODE_result_text3',
              'DX_CODE_result_code3',
              'DX_CODE_result_date4',
              'DX_CODE_result_text4',
              'DX_CODE_result_code4',
              'DX_CODE_result_date5',
              'DX_CODE_result_text5',
              'DX_CODE_result_code5',
              'DX_CODE_result_date6',
              'DX_CODE_result_text6',
              'DX_CODE_result_code6',
              'DX_CODE_result_date7',
              'DX_CODE_result_text7',
              'DX_CODE_result_code7',
              'DX_CODE_result_date8',
              'DX_CODE_result_text8',
              'DX_CODE_result_code8',
              'DX_CODE_result_date9',
              'DX_CODE_result_text9',
              'DX_CODE_result_code9',
              'DX_CODE_result_date10',
              'DX_CODE_result_text10',
              'DX_CODE_result_code10',
              'DX_CODE_result_date11',
              'DX_CODE_result_text11',
              'DX_CODE_result_code11',
              'DX_CODE_result_date12',
              'DX_CODE_result_text12',
              'DX_CODE_result_code12',
              'DX_CODE_result_date13',
              'DX_CODE_result_text13',
              'DX_CODE_result_code13',
              'DX_CODE_result_date14',
              'DX_CODE_result_text14',
              'DX_CODE_result_code14',
              'DX_CODE_result_date15',
              'DX_CODE_result_text15',
              'DX_CODE_result_code15',
              'DX_CODE_result_date16',
              'DX_CODE_result_text16',
              'DX_CODE_result_code16',
              'DX_CODE_result_date17',
              'DX_CODE_result_text17',
              'DX_CODE_result_code17',
              'DX_CODE_result_date18',
              'DX_CODE_result_text18',
              'DX_CODE_result_code18',
              'DX_CODE_result_date19',
              'DX_CODE_result_text19',
              'DX_CODE_result_code19',
              'DX_CODE_result_date20',
              'DX_CODE_result_text20',
              'DX_CODE_result_code20',
              'DX_CODE_result_date21',
              'DX_CODE_result_text21',
              'DX_CODE_result_code21',
              'DX_CODE_result_date22',
              'DX_CODE_result_text22',
              'DX_CODE_result_code22',
              'DX_CODE_result_date23',
              'DX_CODE_result_text23',
              'DX_CODE_result_code23',
              'DX_CODE_result_date24',
              'DX_CODE_result_text24',
              'DX_CODE_result_code24',
              'DX_CODE_result_date25',
              'DX_CODE_result_text25',
              'DX_CODE_result_code25',
              'DX_CODE_result_date26',
              'DX_CODE_result_text26',
              'DX_CODE_result_code26',
              'DX_CODE_result_date27',
              'DX_CODE_result_text27',
              'DX_CODE_result_code27',
              'DX_CODE_result_date28',
              'DX_CODE_result_text28',
              'DX_CODE_result_code28',
              'DX_CODE_result_date29',
              'DX_CODE_result_text29',
              'DX_CODE_result_code29',
              'DX_CODE_count',
              'Prescription_date1',
              'Prescription_name1',
            ...
            if types.startswith('encounter') and AE.name.find('Fever')==-1: 
                ...
                for dx_code in dx_codes:
                    if re.search(r'[0-9]',dx_code):
                        ...
                        dxarray.append(Dx_code.objects.filter(code=dx_code, type='ICD9')[0].name)
