...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('emr_provider', (
            ...
            ('dept_natural_key', self.gf('django.db.models.fields.CharField')(max_length=20, null=True, blank=True)),
        ...
        db.create_table('emr_labresult', (
            ...
            ('order_natural_key', self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True)),
        ...
        db.create_table('emr_laborder', (
            ...
            ('procedure_code', self.gf('django.db.models.fields.CharField')(db_index=True, max_length=20, null=True, blank=True)),
        ...
        db.create_table('emr_prescription', (
            ...
            ('date', self.gf('django.db.models.fields.DateField')(db_index=True)),
            ('mrn', self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True)),
            ('natural_key', self.gf('django.db.models.fields.CharField')(max_length=20, null=True, blank=True)),
        ...
        db.create_table('emr_immunization', (
            ...
            ('date', self.gf('django.db.models.fields.DateField')(db_index=True)),
            ('mrn', self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True)),
            ('natural_key', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True)),
    ...
    models = {
        ...
        'emr.immunization': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'imm_natural_key': ('django.db.models.fields.CharField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'}),
