...
'''
Since 2.x did not actually use timespans, we are not making any attempt at 
all to preserve or migrate hef_timespan_encounters.  
'''
...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field events on 'Timespan'
        db.create_table('hef_timespan_events', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('timespan', models.ForeignKey(orm['hef.timespan'], null=False)),
            ('event', models.ForeignKey(orm['hef.event'], null=False))
        ))
        db.create_unique('hef_timespan_events', ['timespan_id', 'event_id'])
