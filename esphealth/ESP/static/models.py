...
class FakeLabs (models.Model):
    ...
    test_sub_category = models.CharField('Test Sub category', max_length=100)
    specimen_source = models.CharField('Specimen Source', max_length=100)
    ...
    px_type = models.CharField('PX code type', max_length=100)
    units_std = models.CharField('Std Result Units', max_length=100)
    units_ms = models.CharField('MS Result Units', max_length=100)
