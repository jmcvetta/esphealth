...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'CalculatedBilirubinHeuristic.id'
        db.delete_column('hef_calculatedbilirubinheuristic', 'id')

        # Adding field 'CalculatedBilirubinHeuristic.heuristic_ptr'
        db.add_column('hef_calculatedbilirubinheuristic', 'heuristic_ptr', self.gf('django.db.models.fields.related.OneToOneField')(default=0, to=orm['hef.Heuristic'], unique=True, primary_key=True), keep_default=False)


    def backwards(self, orm):
        
        # We cannot add back in field 'CalculatedBilirubinHeuristic.id'
        raise RuntimeError(
            "Cannot reverse this migration. 'CalculatedBilirubinHeuristic.id' and its values cannot be restored.")

        # Deleting field 'CalculatedBilirubinHeuristic.heuristic_ptr'
        db.delete_column('hef_calculatedbilirubinheuristic', 'heuristic_ptr_id')
