...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Site'
        db.create_table('ss_site', (
            ('code', self.gf('django.db.models.fields.CharField')(max_length=20, primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=200)),
            ('zip_code', self.gf('django.db.models.fields.CharField')(max_length=10, db_index=True)),
        ))
        db.send_create_signal('ss', ['Site'])

        # Adding model 'NonSpecialistVisitEvent'
        db.create_table('ss_nonspecialistvisitevent', (
            ('event_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['hef.Event'], unique=True, primary_key=True)),
            ('encounter', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['emr.Encounter'])),
            ('patient_zip_code', self.gf('django.db.models.fields.CharField')(max_length=10, null=True, db_index=True)),
            ('reporting_site', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ss.Site'], null=True)),
        ))
        db.send_create_signal('ss', ['NonSpecialistVisitEvent'])
    
    
    def backwards(self, orm):
        
        # Deleting model 'Site'
        db.delete_table('ss_site')

        # Deleting model 'NonSpecialistVisitEvent'
        db.delete_table('ss_nonspecialistvisitevent')
    ...
    models = {
        ...
        'ss.nonspecialistvisitevent': {
            'Meta': {'object_name': 'NonSpecialistVisitEvent', '_ormbases': ['hef.Event']},
            'encounter': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['emr.Encounter']"}),
            'event_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['hef.Event']", 'unique': 'True', 'primary_key': 'True'}),
            'patient_zip_code': ('django.db.models.fields.CharField', [], {'max_length': '10', 'null': 'True', 'db_index': 'True'}),
            'reporting_site': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['ss.Site']", 'null': 'True'})
        },
        'ss.site': {
