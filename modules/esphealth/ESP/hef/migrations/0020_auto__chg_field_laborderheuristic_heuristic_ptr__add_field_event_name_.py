...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('hef_event', 'name', self.gf('django.db.models.fields.SlugField')(default=None, max_length=127, db_index=True), keep_default=False)

        # Adding field 'Event.uri'
        db.add_column('hef_event', 'uri', self.gf('django.db.models.fields.CharField')(default=None, max_length=255), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column('hef_event', 'name')

        # Deleting field 'Event.uri'
        db.delete_column('hef_event', 'uri')
