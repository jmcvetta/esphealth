...
class Smoking(DiseaseDefinition):
    '''
    Smoking
    '''
    ...
    uri = 'urn:x-esphealth:disease:channing:smoking:v1'
    ...
    #
        ...
        log.info('Generating cases for smoking Definition (a)')
        counter_a = 0
                ...
                if count_dx4 >= 4:
                    ...
                    if rx_qs.count() >= 2: 
                        ...
                        t, new_case = self._create_case_from_event_obj(
                            ...
                            criteria = 'Criteria #1: smoking diagnosis >=4 and >=2 prescriptions',
                        ...
                        if t:
                            counter_a += 1
                            log.info('Created new smoking case def a: %s' % new_case)
        ...
        for rx_event in mainrx_qs:            
            ...
            if not prev_patient or prev_patient != new_patient or rx_event == mainrx_qs[rx_count-1]: 
                if count_rx4 >= 4:  
                    ...
                    if t: 
                        counter_b += 1
                        log.info('Created new smoking case def b: %s' % new_case)
    ...
    def generate(self):
        ...
        transaction.commit()
        log.debug('Generated %s new cases of smoking' % counter)
...
smoking_definition = Smoking()

def event_heuristics():
    return smoking_definition.event_heuristics

def disease_definitions():
    return [smoking_definition]
