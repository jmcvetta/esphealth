...
setup(
    name = 'esphealth-disease-gonorrhea',
    version = '1.0',
    ...
    license = 'LGPLv3',
    keywords = 'gonorrhea algorithm disease surveillance public health epidemiology',
    ...
    entry_points = '''
        [esphealth]
        disease_definitions = gonorrhea:disease_definitions
        event_heuristics = gonorrhea:event_heuristics
    '''
    )
