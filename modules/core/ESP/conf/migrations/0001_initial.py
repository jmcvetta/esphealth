...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('conf_codemap', (
            ...
            ('reportable', self.gf('django.db.models.fields.BooleanField')(default=True, db_index=True, blank=True)),
    ...
    models = {
        'conf.codemap': {
            ...
            'reportable': ('django.db.models.fields.BooleanField', [], {'default': 'True', 'db_index': 'True', 'blank': 'True'}),
