...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'LabResultWesternBlotHeuristic'
        db.create_table('hef_labresultwesternblotheuristic', (
            ...
            ('bands', self.gf('django.db.models.fields.CharField')(max_length=256)),
        ))
        db.send_create_signal('hef', ['LabResultWesternBlotHeuristic'])

        # Adding unique constraint on 'LabResultWesternBlotHeuristic', fields ['test']
        db.create_unique('hef_labresultwesternblotheuristic', ['test_id'])

        # Adding field 'LabResultAnyHeuristic.date_field'
        db.add_column('hef_labresultanyheuristic', 'date_field', self.gf('django.db.models.fields.CharField')(default='order', max_length=32), keep_default=False)


    def backwards(self, orm):
        
        # Removing unique constraint on 'LabResultWesternBlotHeuristic', fields ['test']
        db.delete_unique('hef_labresultwesternblotheuristic', ['test_id'])

        # Deleting model 'LabResultWesternBlotHeuristic'
        db.delete_table('hef_labresultwesternblotheuristic')

        # Deleting field 'LabResultAnyHeuristic.date_field'
        db.delete_column('hef_labresultanyheuristic', 'date_field')
