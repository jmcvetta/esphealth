...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'LabResultRangeHeuristic'
        db.create_table('hef_labresultrangeheuristic', (
            ...
            ('minimum_match_type', self.gf('django.db.models.fields.CharField')(max_length=3)),
            ('maximum', self.gf('django.db.models.fields.FloatField')()),
            ('maximum_match_type', self.gf('django.db.models.fields.CharField')(max_length=3)),
        ))
        db.send_create_signal('hef', ['LabResultRangeHeuristic'])

        # Adding unique constraint on 'LabResultRangeHeuristic', fields ['test', 'minimum', 'maximum']
        db.create_unique('hef_labresultrangeheuristic', ['test_id', 'minimum', 'maximum'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'LabResultRangeHeuristic', fields ['test', 'minimum', 'maximum']
        db.delete_unique('hef_labresultrangeheuristic', ['test_id', 'minimum', 'maximum'])

        # Deleting model 'LabResultRangeHeuristic'
        db.delete_table('hef_labresultrangeheuristic')
