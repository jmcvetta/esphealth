...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('nodis_referencecase', (
            ...
            ('ignore', self.gf('django.db.models.fields.BooleanField')(default=False, db_index=True, blank=True)),
            ('date', self.gf('django.db.models.fields.DateField')(db_index=True)),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('condition', self.gf('django.db.models.fields.CharField')(max_length=100, db_index=True)),
        ))
    ...
    models = {
        ...
        'nodis.case': {
            'Meta': {'unique_together': "(['patient', 'condition', 'date'],)", 'object_name': 'Case'},
            ...
            'events_after': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'case_after'", 'symmetrical': 'False', 'to': "orm['hef.Event']"}),
            'events_before': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'case_before'", 'symmetrical': 'False', 'to': "orm['hef.Event']"}),
            'events_ever': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'case_ever'", 'symmetrical': 'False', 'to': "orm['hef.Event']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'nodis.referencecase': {
            ...
            'date': ('django.db.models.fields.DateField', [], {'db_index': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'ignore': ('django.db.models.fields.BooleanField', [], {'default': 'False', 'db_index': 'True', 'blank': 'True'}),
