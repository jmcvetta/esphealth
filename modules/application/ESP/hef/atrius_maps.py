...
gcrf_result = AbstractLabTest.objects.get(name='glucose_compound_random_fasting_result')
gcrf_flag = AbstractLabTest.objects.get(name='glucose_compound_random_fasting_flag')
