...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('emr_provider', (
            ...
            ('provider_id_num', self.gf('django.db.models.fields.CharField')(db_index=True, max_length=20, unique=True, null=True, blank=True)),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
        ...
        db.create_table('emr_patient', (
            ...
            ('patient_id_num', self.gf('django.db.models.fields.CharField')(db_index=True, max_length=20, unique=True, null=True, blank=True)),
            ('created_timestamp', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ...
        db.create_table('emr_encounter', (
            ...
            ('native_encounter_num', self.gf('django.db.models.fields.CharField')(db_index=True, max_length=20, null=True, blank=True)),
            ('created_timestamp', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ...
            ('pregnancy_status', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True)),
        ))
